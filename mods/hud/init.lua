...
HUD_SHOW_ARMOR = true  -- rnd, this will show mana..
...
local function update_hud(player)
 ...
 -- mana -- rnd.. armor FIX HERE.... TO DISPLAY MANA 
	local arm_out = playerdata[name].mana
	if arm_out~= nil then
		local arm = tonumber(hud.armor[name])
		
		if arm_out ~= arm then
			hud.armor_out[name] = arm_out
			player:hud_change(armor_hud[name], "number", arm_out)
			end
	end
 --hunger
