...
local oredefs = {
	silver = {
		...
		tools = {
			...
			sword = {
				fleshy = {times = {[2] = 0.70, [3] = 0.30}, uses = 1500, maxlevel= 1},
				snappy = {times = {[2] = 0.70, [3] = 0.30}, uses = 1500, maxlevel= 1},
	...
	mithril = {
		...
		tools = {
			...
			shovel = {
				crumbly = {times = {[1] = 0.70, [2] = 0.35, [3] = 0.20}, uses = 1000, maxlevel= 4}
			},
			axe = {
				choppy = {times = {[1] = 1.75, [2] = 0.45, [3] = 0.45}, uses = 2000, maxlevel= 4},
